...
class Card extends Component {
    ...
    handleFormSubmit(event) {
        ...
        if(this.state.contentVisible){
            ...
            console.log('contenct is no longer available')
        } else {
    ...
    render (){
        ...
        return (
            <form onSubmit={this.handleFormSubmit} className='card'>
                ...
                <button className={`card__${!this.state.contentVisible ? 'generate' : 'clear'}`} type="submit">{!this.state.contentVisible ? 'Generate Mad Li' : 'Clear Form'}</button>
                {
